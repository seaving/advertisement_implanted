...
extern void * (*__mmap_hook)(__ptr_t, size_t, int, int, int, off_t);
extern void * (*__mmap64_hook)(__ptr_t, size_t, int, int, int, __off64_t);
extern int (*__munmap_hook)(void *, size_t);
extern __ptr_t ext_mmap(__ptr_t addr, size_t len, int prot,
			int flags, int fd, __off_t offset);
extern __ptr_t ext_mmap64(__ptr_t addr, size_t len, int prot,
			int flags, int fd, __off64_t offset);			
extern int ext_munmap(void *start, size_t length);
