...
/* ZTE-OS modify */
/* set_timezone used to set time zone offset of UTC
                the param is minutis offset UTC 
                success return 0
                fail returen -1*/
/* get_timezone used to get the minutes offset of UTC */
extern int set_timezone(int);
extern int get_timezone(void);
