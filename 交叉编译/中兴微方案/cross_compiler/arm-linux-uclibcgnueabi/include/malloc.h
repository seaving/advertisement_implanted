...
extern void (*__free_hook)(__malloc_ptr_t __ptr, const __malloc_ptr_t);
extern void * (*__malloc_hook)(size_t __size, const __malloc_ptr_t);
extern void * (*__realloc_hook)(__malloc_ptr_t __ptr, size_t __size, const __malloc_ptr_t);
extern void * (*__memalign_hook)(size_t __alignment, size_t __size, const __malloc_ptr_t);

extern void ext_free(void* mem);
extern void* ext_malloc(size_t bytes);
extern void* ext_memalign(size_t alignment, size_t bytes);
extern void* ext_realloc(void* oldmem, size_t bytes);
