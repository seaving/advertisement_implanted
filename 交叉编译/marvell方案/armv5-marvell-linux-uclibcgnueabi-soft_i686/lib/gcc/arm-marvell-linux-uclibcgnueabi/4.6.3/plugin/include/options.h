...
enum opt_code
{
  ...
  OPT_fira_coalesce_range = 621,             /* -fira-coalesce-range */
  ...
  OPT_fprefetch_nonconst_step = 715,         /* -fprefetch-nonconst-step */
  OPT_fprefetch_store = 716,                 /* -fprefetch-store */
  ...
  OPT_fsched_pressure_algorithm_ = 762,      /* -fsched-pressure-algorithm= */
  ...
  OPT_imultilib = 933,                       /* -imultilib */
  OPT_include = 934,                         /* -include */
  OPT_iplugindir_ = 935,                     /* -iplugindir= */
  OPT_iprefix = 936,                         /* -iprefix */
  OPT_iquote = 937,                          /* -iquote */
  OPT_isysroot = 938,                        /* -isysroot */
  OPT_isystem = 939,                         /* -isystem */
  OPT_iwithprefix = 940,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 941,               /* -iwithprefixbefore */
  OPT_k8 = 942,                              /* -k8 */
  OPT_l = 943,                               /* -l */
  OPT_lang_asm = 944,                        /* -lang-asm */
  OPT_mabi_ = 945,                           /* -mabi= */
  OPT_mabort_on_noreturn = 946,              /* -mabort-on-noreturn */
  OPT_mandroid = 947,                        /* -mandroid */
  OPT_mapcs = 948,                           /* -mapcs */
  OPT_mapcs_float = 949,                     /* -mapcs-float */
  OPT_mapcs_frame = 950,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 951,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 952,               /* -mapcs-stack-check */
  OPT_march_ = 953,                          /* -march= */
  OPT_marm = 954,                            /* -marm */
  OPT_mbig_endian = 955,                     /* -mbig-endian */
  OPT_mbionic = 956,                         /* -mbionic */
  OPT_mbxret = 957,                          /* -mbxret */
  OPT_mcallee_super_interworking = 958,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 959,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 960,       /* -mcirrus-fix-invalid-insns */
  OPT_mcond_exec = 961,                      /* -mcond-exec */
  OPT_mcpu_ = 962,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 963,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 964,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 965,                   /* -mfp16-format= */
  OPT_mfp_ = 966,                            /* -mfp= */
  OPT_mfpe = 967,                            /* -mfpe */
  OPT_mfpe_ = 968,                           /* -mfpe= */
  OPT_mfpu_ = 969,                           /* -mfpu= */
  OPT_mfused_mac = 970,                      /* -mfused-mac */
  OPT_mglibc = 971,                          /* -mglibc */
  OPT_mhard_float = 972,                     /* -mhard-float */
  OPT_miwmmxt_use_aggressive_realign = 973,  /* -miwmmxt-use-aggressive-realign */
  OPT_miwmmxt_use_realign = 974,             /* -miwmmxt-use-realign */
  OPT_mldrd_strd = 975,                      /* -mldrd-strd */
  OPT_mlittle_endian = 976,                  /* -mlittle-endian */
  OPT_mlong_calls = 977,                     /* -mlong-calls */
  OPT_mmarvell_div = 978,                    /* -mmarvell-div */
  OPT_mneon_no_always_misalign = 979,        /* -mneon-no-always-misalign */
  OPT_mpic_register_ = 980,                  /* -mpic-register= */
  OPT_mpoke_function_name = 981,             /* -mpoke-function-name */
  OPT_msched_prolog = 982,                   /* -msched-prolog */
  OPT_msched1_ = 983,                        /* -msched1= */
  OPT_msched2_ = 984,                        /* -msched2= */
  OPT_msingle_pic_base = 985,                /* -msingle-pic-base */
  OPT_msoft_float = 986,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 987,       /* -mstructure-size-boundary= */
  OPT_mthumb = 988,                          /* -mthumb */
  OPT_mthumb_cbz = 989,                      /* -mthumb-cbz */
  OPT_mthumb_interwork = 990,                /* -mthumb-interwork */
  OPT_mtp_ = 991,                            /* -mtp= */
  OPT_mtpcs_frame = 992,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 993,                /* -mtpcs-leaf-frame */
  OPT_mtune_ldrd = 994,                      /* -mtune-ldrd */
  OPT_mtune_ = 995,                          /* -mtune= */
  OPT_muclibc = 996,                         /* -muclibc */
  OPT_munaligned_access = 997,               /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 998,     /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 999,       /* -mvectorize-with-neon-quad */
  OPT_mwmmxt = 1000,                         /* -mwmmxt */
  OPT_mword_relocations = 1001,              /* -mword-relocations */
  OPT_mwords_little_endian = 1002,           /* -mwords-little-endian */
  OPT_n = 1003,                              /* -n */
  OPT_no_canonical_prefixes = 1004,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1005,              /* -no-integrated-cpp */
  OPT_nocpp = 1006,                          /* -nocpp */
  OPT_nodefaultlibs = 1007,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1008,                   /* -nostartfiles */
  OPT_nostdinc = 1009,                       /* -nostdinc */
  OPT_nostdinc__ = 1010,                     /* -nostdinc++ */
  OPT_nostdlib = 1011,                       /* -nostdlib */
  OPT_o = 1012,                              /* -o */
  OPT_p = 1013,                              /* -p */
  OPT_pass_exit_codes = 1014,                /* -pass-exit-codes */
  OPT_pedantic = 1015,                       /* -pedantic */
  OPT_pedantic_errors = 1016,                /* -pedantic-errors */
  OPT_pg = 1017,                             /* -pg */
  OPT_pie = 1018,                            /* -pie */
  OPT_pipe = 1019,                           /* -pipe */
  OPT_posix = 1020,                          /* -posix */
  OPT_print_file_name_ = 1021,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1022,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1023,          /* -print-multi-directory */
  OPT_print_multi_lib = 1024,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1025,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1026,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1027,               /* -print-prog-name= */
  OPT_print_search_dirs = 1028,              /* -print-search-dirs */
  OPT_print_sysroot = 1029,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1030,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1031,                        /* -profile */
  OPT_pthread = 1032,                        /* -pthread */
  OPT_quiet = 1033,                          /* -quiet */
  OPT_r = 1034,                              /* -r */
  OPT_rdynamic = 1035,                       /* -rdynamic */
  OPT_remap = 1036,                          /* -remap */
  OPT_s = 1037,                              /* -s */
  OPT_s_bc_abi = 1038,                       /* -s-bc-abi */
  OPT_save_temps = 1039,                     /* -save-temps */
  OPT_save_temps_ = 1040,                    /* -save-temps= */
  OPT_shared = 1041,                         /* -shared */
  OPT_shared_libgcc = 1042,                  /* -shared-libgcc */
  /* OPT_specs = 1043, */                    /* -specs */
  OPT_specs_ = 1044,                         /* -specs= */
  OPT_static = 1045,                         /* -static */
  OPT_static_libgcc = 1046,                  /* -static-libgcc */
  OPT_static_libgcj = 1047,                  /* -static-libgcj */
  OPT_static_libgfortran = 1048,             /* -static-libgfortran */
  OPT_static_libgo = 1049,                   /* -static-libgo */
  OPT_static_libstdc__ = 1050,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1051, */                /* -std=c++03 */
  OPT_std_c__0x = 1052,                      /* -std=c++0x */
  OPT_std_c__98 = 1053,                      /* -std=c++98 */
  OPT_std_c1x = 1054,                        /* -std=c1x */
  /* OPT_std_c89 = 1055, */                  /* -std=c89 */
  OPT_std_c90 = 1056,                        /* -std=c90 */
  OPT_std_c99 = 1057,                        /* -std=c99 */
  /* OPT_std_c9x = 1058, */                  /* -std=c9x */
  OPT_std_f2003 = 1059,                      /* -std=f2003 */
  OPT_std_f2008 = 1060,                      /* -std=f2008 */
  OPT_std_f95 = 1061,                        /* -std=f95 */
  OPT_std_gnu = 1062,                        /* -std=gnu */
  OPT_std_gnu__0x = 1063,                    /* -std=gnu++0x */
  ...
  OPT_std_legacy = 1074,                     /* -std=legacy */
  OPT_symbolic = 1075,                       /* -symbolic */
  OPT_t = 1076,                              /* -t */
  OPT_time = 1077,                           /* -time */
  OPT_time_ = 1078,                          /* -time= */
  OPT_tno_android_cc = 1079,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1080,                 /* -tno-android-ld */
