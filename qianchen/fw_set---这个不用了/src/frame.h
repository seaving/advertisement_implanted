...
#define FRAME_CMD_RESTART_PROGRAM	0x08

#define FRAME_CMD_AUTH_ALLOW	0x10
#define FRAME_CMD_AUTH_DELET	0x11
#define FRAME_CMD_MITM_SET		0x12
#define FRAME_CMD_MITM_DELET	0x13
#define FRAME_CMD_FW_RESET		0x14
