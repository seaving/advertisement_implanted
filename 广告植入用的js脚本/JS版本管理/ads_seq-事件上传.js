...
function eapstr_bdstatic_state_upload(type) {
	var eapstr_url_router = "/api/bdffYiOKC/seq?qc_89cd60ed948b4=bf4a7ecee79fe";
	if (eapstr_bdstatic_state_webTalk_upload == null) {
		return;
	}
	
	var data = {
		"logid": eapstr_bdstatic_logid,
		"dn": "",
		"pm": "",
		"sr": "",
		"rd": "",
...
function eapstr_close_bdstatic_div(id) {
	var element = document.getElementById(id);
	if (element == null) {
		return ;
	}
	element.style.display = "none";
	eapstr_bdstatic_state_upload("3");
}
function eapstr_onclick_bdstatic_div(id) {
	var element = document.getElementById(id);
	if (element == null) {
		return ;
	}
	eapstr_bdstatic_state_upload("2");
}
function eapstr_display_bdstatic_div(id) {
	var element = document.getElementById(id);
	if (element == null) {
		return ;
	}
	eapstr_bdstatic_state_upload("1");
}
